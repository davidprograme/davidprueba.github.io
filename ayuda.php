             ...
             <nav class="nav" id="nav">
                 ...
                 <ul class="nav-list">
                    ...
                    <li class="li_menu"><a href="informacion.php">Información NOVA</a></li>
                     <li class="li_menu"><a href="#">Contacto</a></li>
...
<section class="section_ayuda">
    <div class="div_ayuda">
        <h1 class="h1_titulo">Preguntas Frecuentes.</h1>

        <div class="div_preguntas">
            <details>
                <summary>¿Como iniciar sesión?</summary>
                <p>fadfafasdfadfafadfaf</p>
            </details>
            <details>
                <summary>¿Como iniciar sesiósn?</summary>
                <p>fadfafasdfadfafadfaf</p>
            </details>
            <details>
                <summary>¿Como iniciar sesiósn?</summary>
        ...
        <div class="div_opciones_usuario_Pie">
            <div class="div_ul_opciones">
                <ul class="ul_opciones">
                    ...
                    <li class="li_opciones"><a class="a_pie" href="informacion.php#quienes_somos">¿Quiénes somos?</a></li>
