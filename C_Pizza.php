...
<head>
    ...
    <title>NOVA | Sección De Comida </title>
...
<section class="section_opciones_usuario">
    ...
    <?php
        require_once "bdd.php";
         $sql = "SELECT * FROM usuario_nuevo_nova WHERE checkbox = 'Pizza'";
...
<script> 
 ...
 cerrar.addEventListener("click", () => {
    ...
    .menu_horizontal > .li_contactoo:hover{
        width: 90%;
        margin: 0px auto;
        border-top: 1px solid gray;
        padding-top: 10px;
    ...
    .menu_horizontal .li_contactoo:hover .menu_vertical{
        display: block;
    }
    .menu_vertical .li_contactoo:hover{
        width: auto;
    }
    .menu_vertical .li_contactoo{
        display: block;
        color: black;
        padding-bottom: 5px;
        margin: 10px 25px;
