            ...
            <ul id="box-search">
                <?php
                    ...
                    if(mysqli_num_rows($resultado) > 0){
                        ...
                        echo '<li><a href="articulo.html"><i class="fas fa-search"></i>'.$fila['nombre_empre'].'</a></li>';
                        }
                    }else{
...
<?php
         $sql2 = "SELECT * FROM usuario_nuevo_nova WHERE checkbox = 'Servicios Técnicos/Software'";
